...
// settled).
//
// Data sections come before the judging criteria (unlike a "---"-separated
// afterthought) so a bullet can correctly say "the list above" — entry/
// member formatting is shared with extract/respond/summarize via
// ../format-window.js, not reimplemented here.
...
You are the gate this thread's messages pass through. One tool call, \`submit_gate_decision\`, does two separate things:
...
Judge the whole batch of new messages above, together.
