# Calibration pack — Response quality (grader A)
...
| Q-3 | 3 | identifies all tasks discussed but mention of payload shape instead of response shape |
| Q-4 | 4 | [reason not recovered] |
| Q-5 | 2 | [reason not recovered] |
| Q-6 | 4 | [reason not recovered] |
| Q-7 | 2 | [reason not recovered] |
...
| Q-13 | 1 | question is not properly answered with the tasks, also inaccurate mention of completion |
