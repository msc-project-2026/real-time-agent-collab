# Calibration pack — Task fidelity (grader A)
...
|---|---|---|
| T-1 | 4 | accurately captures details of task along with follow up |
| T-2 | 4 | describes issues and task to be completed |
| T-3 | 1 | fabricated task as there is no mention of migration in the conversation |
| T-4 | 3 | captures the key idea but vague in describing what to actually change about the dashboard |
| T-5 | 4 | captures all details related to task of fixing the empty state |
| T-6 | 2 | correct task identified but includes inaccurate details like date of standup |
| T-7 | 2 | correct task identified but mentions details that are not discussed at all such as RBAC service |
| T-8 | 4 | captures all details of task |
| T-9 | 3 | [reason not recovered] |
| T-10 | 2 | [reason not recovered] |
| T-11 | 1 | fabricates a task that is interpretted inaccurately from the conversation |
| T-12 | 4 | [reason not recovered] |
| T-13 | 4 | [reason not recovered] |
| T-14 | 3 | slightly vague in describing the axact task |
| T-15 | 4 | [reason not recovered] |
| T-16 | 4 | (revised on review by the grader) |
| T-17 | 3 | [reason not recovered] |
| T-18 | 4 | accurately captures all details of mentioned task |
| T-19 | 3 | [reason not recovered] |
| T-20 | 4 | [reason not recovered] |
| T-21 | 1 | [reason not recovered] |
| T-22 | 2 | overly specific and omits key details mentioned |
| T-23 | 4 | [reason not recovered] |
